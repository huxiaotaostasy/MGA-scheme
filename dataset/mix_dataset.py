...
if __name__ == '__main__':
    ...
    D = MixDataset(hr_paths=['/home/ubuntu/Downloads/SRdataset/DIV2K/DIV2K_train_HR_sub'],
                   lr_paths=['/home/ubuntu/Downloads/SRdataset/DIV2K/DIV2K_train_LR_bicubic_sub/X4'],
                   config=config)
