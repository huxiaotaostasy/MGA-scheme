...
def main():
    ...
    input_folder = '/home/ubuntu/Downloads/SRdataset/DIV2K/DIV2K_train_HR'  # original image folder
    save_folder = '/home/ubuntu/Downloads/SRdataset/DIV2K/DIV2K_train_HR_sub'  # the created sub-image folder
    n_thread = 20
